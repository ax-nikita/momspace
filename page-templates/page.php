...
?>
    <div class="simple-box pressure">
        <?php while (have_posts()) : the_post(); ?>
            <div data-id="article-content" class="article-box type-1 simple-boxes-areas">
                <h1><?php the_title(); ?></h1>
                ...
                <div class="article-box__simple-box-wrapper">
                    <div loadVisible="true" class="row simple-box" domLoader="<?php echo buildDomLoaderUrl('simple-box-planirovanie-beremenosty', 'post', []); ?>"></div>
                </div>
    ...
    <div loadVisible="true" class="row simple-box padding-bottom-69 extra-padding back-lblue" domLoader="<?php echo buildDomLoaderUrl('simple-box-posts-recommended-type-1'); ?>"></div>
<?php get_footer();