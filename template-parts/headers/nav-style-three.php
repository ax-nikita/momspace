	...
	<div class="theme-header-wrap-main logo-area">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="<?php if($register_btn_enable == false ) { echo "col-lg-9"; } else { echo "col-lg-7"; } ?> col-md-12 nav-design-twoo megamenu-col-wrapper">
				...
				<div class="<?php if($register_btn_enable == false ) { echo "col-lg-1"; } else { echo "col-lg-3"; } ?>">
